...
void CvSelectionGroup::startMission()
{
    ...
    // AltAI - don't hold if only workers in group as causes mission to be cleared and a possibly new one pushed
    // if any workers in the group have moves, they will be used in continueMission()
