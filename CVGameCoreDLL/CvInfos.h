...
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvInfoBase // AltAI: would like to use: " : boost::noncopyable" here, but python wrappers seem to prevent it
                 // don't try and copy these Info objects though without writing some ctors 
{
//---------------------------------------PUBLIC INTERFACE---------------------------------
public:
