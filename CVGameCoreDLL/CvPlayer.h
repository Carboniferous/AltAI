...
public:
    ...
    // AltAI - added const CvUnit* pUpgradingUnit = (const CvUnit*)0 argument
	CvUnit* initUnit(UnitTypes eUnit, int iX, int iY, UnitAITypes eUnitAI = NO_UNITAI, DirectionTypes eFacingDirection = NO_DIRECTION, const CvUnit* pUpgradingUnit = (const CvUnit*)0);							// Exposed to Python
...
/*************************************************************************************************/
    ...
    // AltAI
    DllExport bool isUsingAltAI() const;
    DllExport void setUsingAltAI(bool flag);
